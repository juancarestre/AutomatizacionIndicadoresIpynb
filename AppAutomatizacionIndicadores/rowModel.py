...
#     def __init__(self,app,sprintNumber,sumaDefectos,sumaCasosPrueba,FileName):
...
#                 self.CPManuales=duda['RUN_MANUAL'].values.tolist()[0]
#                 self.CPAutomáticos=duda['RUN_AUTO'].values.tolist()[0]
...
#                 self.DefectosManuales=duda['Automatic Defect_N'].values.tolist()[0]
#                 self.DefectosAutomáticos=duda['Automatic Defect_Y'].values.tolist()[0]
#                 self.DefectosTotales=self.DefectosManuales+self.DefectosAutomáticos
#                 self.ImpactoAlto=duda['Business Impact_A-High'].values.tolist()[0]
#                 self.ImpactoMedio=duda['Business Impact_B-Medium'].values.tolist()[0]
#                 self.ImpactoBajo=duda['Business Impact_C-Low'].values.tolist()[0]
